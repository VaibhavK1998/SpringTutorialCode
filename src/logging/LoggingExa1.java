...
public class LoggingExa1 {
	...
	public static void main(String[] args) {
		try {
			FileHandler fileHandler=new FileHandler("C:\\Users\\HP\\Desktop\\NewEclipseWorkspace\\SpringProject2\\src\\logging\\logFiles\\log1.log");// the file where we have to store the log
